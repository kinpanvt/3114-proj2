 ...
 * including insertion, removal, and search functionalities within a PR Quadtree.
 */
public class LeafNodeTest extends TestCase {
    ...
    private Point point3; // Point with the same name as point1 but different coordinates
    ...
    public void testInsert() {
        ...
        assertTrue("LeafNode should remain after inserting one point", resultNode instanceof LeafNode);
        
        // Insert another point and test for split
        resultNode = resultNode.insert(point2, 0, 0, 1024);
        assertTrue("Should return an InternalNode after inserting a second point", resultNode instanceof InternalNode);
    }
    ...
    public void testSearchByName() {
        ...
        assertEquals("Should find two points with the same name", 2, foundPoints.size());
    }
    ...
    public void testRegionSearch() {
        ...
        List<Point> foundPoints = leafNode.regionSearch(50, 50, 100, 100, 0, 0, 1024);
        assertEquals("Should find 1 point in the specified region", 1, foundPoints.size());
        assertTrue("Found point should be point1", foundPoints.contains(point1));
